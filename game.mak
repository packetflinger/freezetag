...
CPP=cl.exe
CPP_PROJ=/nologo /G5 /MT /GX /Zd /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /Fp"$(INTDIR)\game.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib ws2_32.lib /nologo /base:"0x20000000" /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\gamex86.pdb" /machine:I386 /def:".\game.def" /out:"$(OUTDIR)\gamex86.dll" /implib:"$(OUTDIR)\gamex86.lib" 
DEF_FILE= \
	".\game.def"
LINK32_OBJS= \
	"$(INTDIR)\freeze.obj" \
...
CLEAN :
	...
	-@erase "$(OUTDIR)\gamex86.dll"
	-@erase "$(OUTDIR)\gamex86.exp"
	-@erase "$(OUTDIR)\gamex86.ilk"
	-@erase "$(OUTDIR)\gamex86.lib"
	-@erase "$(OUTDIR)\gamex86.map"
...
LINK32=link.exe
LINK32_FLAGS=winmm.lib wsock32.lib kernel32.lib user32.lib ws2_32.lib /nologo /base:"0x20000000" /subsystem:windows /dll /incremental:yes /pdb:"$(OUTDIR)\gamex86.pdb" /map:"$(INTDIR)\gamex86.map" /debug /machine:I386 /def:".\game.def" /out:"$(OUTDIR)\gamex86.dll" /implib:"$(OUTDIR)\gamex86.lib" 
DEF_FILE= \
	".\game.def"
LINK32_OBJS= \
	"$(INTDIR)\freeze.obj" \
...
SOURCE="$(InputPath)"
PostBuild_Desc=Copying files to freeze
...
$(DS_POSTBUILD_DEP) : "$(OUTDIR)\gamex86.dll" "$(OUTDIR)\game.bsc"
   copy .\debug\gamex86.dll c:\quake2\freeze\gamex86.dll
	copy .\debug\gamex86.pdb c:\quake2\freeze\gamex86.pdb
...
LINK32=link.exe
LINK32_FLAGS=gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib wsock32.lib kernel32.lib user32.lib ws2_32.lib /nologo /base:"0x20000000" /subsystem:windows /dll /incremental:yes /pdb:"$(OUTDIR)\gameaxp.pdb" /debug /machine:ALPHA /def:".\game.def" /out:"$(OUTDIR)\gameaxp.dll" /implib:"$(OUTDIR)\gameaxp.lib" 
DEF_FILE= \
	".\game.def"
LINK32_OBJS= \
...
LINK32=link.exe
LINK32_FLAGS=ws2_32.lib kernel32.lib user32.lib /nologo /base:"0x20000000" /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\gameaxp.pdb" /machine:ALPHA /def:".\game.def" /out:"$(OUTDIR)\gameaxp.dll" /implib:"$(OUTDIR)\gameaxp.lib" 
DEF_FILE= \
	".\game.def"
LINK32_OBJS= \
...
"$(INTDIR)\freeze.obj" : $(SOURCE) "$(INTDIR)"


!ELSEIF  "$(CFG)" == "game - Win32 Debug"


"$(INTDIR)\freeze.obj"	"$(INTDIR)\freeze.sbr" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\gslog.obj" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\sl_packet.obj" : $(SOURCE) "$(INTDIR)"


!ELSEIF  "$(CFG)" == "game - Win32 Debug"


"$(INTDIR)\sl_packet.obj"	"$(INTDIR)\sl_packet.sbr" : $(SOURCE) "$(INTDIR)"
